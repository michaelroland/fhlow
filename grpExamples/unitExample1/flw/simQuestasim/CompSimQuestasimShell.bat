...
set CURR_SIM_DIRECTORY=%~dp0
set CURR_SIM_DRIVE=%~d0
set CURR_BASE_DIRECTORY=%CURR_SIM_DIRECTORY%..\..\..\..\
...
"%MY_QUESTASIM_EXEC_VSIM%" -c -do ../../../../fhlow/simQuestasim/CompSimShell.do
